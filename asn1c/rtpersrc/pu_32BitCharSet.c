...
EXTPERMETHOD void pu_init32BitCharSet (Asn132BitCharSet* pCharSet, OS32BITCHAR first,
...
EXTPERMETHOD void pu_set32BitCharSet (OSCTXT* pctxt, 
                         ...
                         Asn132BitCharSet* pAlphabet)
{
   ...
   if (pAlphabet->charSet.data) {
      int nocts = pAlphabet->charSet.nchars * sizeof (OS32BITCHAR);
   ...
   pCharSet->unalignedBits = pu_bitcnt (pCharSet->charSet.nchars);
...
EXTPERMETHOD void pu_set32BitCharSetFromRange (Asn132BitCharSet* pCharSet, 
                                  OSUINT32 firstChar, 
                                  OSUINT32 lastChar)
{
