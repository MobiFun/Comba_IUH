...
/***********************************************************************
 *
 *  Routine name: pe_16BitConstrainedString
 *
 *  Description:  The following function encodes a 16-bit constrained
 *                string value.
 *
 *  Inputs:
 *
 ...
 *  data        struct* pointer to 16-bit string structure to encode
 *
 *  Outputs:
 *
 *  Name        Type    Description
...
EXTPERMETHOD int pe_16BitConstrainedString (OSCTXT* pctxt, 
