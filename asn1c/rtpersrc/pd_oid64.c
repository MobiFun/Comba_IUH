...
EXTPERMETHOD int pd_oid64 (OSCTXT* pctxt, ASN1OID64* pvalue)
{
   OSUINT32   len;
   int        stat, j;
   OSUINT64 subid;
   ...
   j = 0;
   while (len > 0 && stat == 0) /*!AB (09/02/2002) - check the stat as well. */
   {
      if (j < ASN_K_MAXSUBIDS) {     /*!AB (09/02/2002) */
