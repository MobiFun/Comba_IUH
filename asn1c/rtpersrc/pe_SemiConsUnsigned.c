...
EXTPERMETHOD int pe_SemiConsUnsigned (OSCTXT* pctxt, OSUINT32 value, OSUINT32 lower)
{
   int nbytes, stat;
   ...
   for ( ; shift > 0; shift -= 8) {
      ...
      RTDIAGSTRM4 
         (pctxt, "pe_SemiConsUnsigned: shift is %d, tempValue is 0x%x\n", 
          shift, tempValue);
   ...
   nbytes = (shift + 9) / 8;
   RTDIAGSTRM3 (pctxt,"pe_SemiConsUnsigned: nbytes is %d\n", nbytes);
   ...
   PU_NEWFIELD (pctxt, "SemiConsUnsigned");
   ...
   stat = pe_NonNegBinInt (pctxt, value);
...
EXTPERMETHOD int pe_UnconsUnsigned (OSCTXT* pctxt, OSUINT32 value)
{
   ...
   for ( ; shift > 0; shift -= 8) {
      ...
      RTDIAGSTRM4 (pctxt, "pe_UnconsUnsigned: "
   ...
   nbytes = (shift + 9) / 8;
   RTDIAGSTRM3 (pctxt,"pe_UnconsUnsigned: nbytes is %d\n", nbytes);
   ...
   stat = pe_2sCompBinInt (pctxt, (OSINT32)value);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
