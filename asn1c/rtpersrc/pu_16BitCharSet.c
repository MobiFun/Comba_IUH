...
EXTPERMETHOD void pu_init16BitCharSet (Asn116BitCharSet* pCharSet, OSUNICHAR first,
...
EXTPERMETHOD void pu_set16BitCharSet (OSCTXT* pctxt, 
                         ...
                         Asn116BitCharSet* pAlphabet)
{
   ...
   if (pAlphabet->charSet.data) {
      ...
      pCharSet->charSet.data = 
         (OSUNICHAR*) rtxMemAlloc (pctxt, nocts);
...
EXTPERMETHOD void pu_set16BitCharSetFromRange (Asn116BitCharSet* pCharSet, 
                                  OSUINT16 firstChar, 
                                  OSUINT16 lastChar)
{
