...
{
   strcpy (timeStr, original.timeStr);
}
...
*/
EXTRTMETHOD int ASN1CTime::setYear(int year_) {
   if(!parsed)
      getTimeObj().parseString(timeStr);
...
* Returns 0, if succeed, or error code, if error.
*/
EXTRTMETHOD int ASN1CTime::setMonth(int month_) {
   if(!parsed)
      getTimeObj().parseString(timeStr);
...
* Returns 0, if succeed, or error code, if error.
*/
EXTRTMETHOD int ASN1CTime::setDay(int day_) {
   if(!parsed)
      getTimeObj().parseString(timeStr);
...
* Returns 0, if succeed, or error code, if error.
*/
EXTRTMETHOD int ASN1CTime::setHour(int hour_) {
   if(!parsed)
      getTimeObj().parseString(timeStr);
...
* Returns 0, if succeed, or error code, if error.
*/
EXTRTMETHOD int ASN1CTime::setMinute(int minute_) {
   if(!parsed)
      getTimeObj().parseString(timeStr);
...
* Returns 0, if succeed, or error code, if error.
*/
EXTRTMETHOD int ASN1CTime::setSecond(int second_) {
   if(!parsed)
      getTimeObj().parseString(timeStr);
...
*/
EXTRTMETHOD int ASN1CTime::setDiffHour(int dhour) {
   if(!parsed)
      getTimeObj().parseString(timeStr);
...
*          RTERR_INVFORMAT - if value is invalid.
*/
EXTRTMETHOD int ASN1CTime::setDiff(int dhour, int dminute) {
   if(!parsed)
      getTimeObj().parseString(timeStr);
...
*          RTERR_INVFORMAT - if value is invalid.
*/
EXTRTMETHOD int ASN1CTime::setDiff(int inMinutes) {
   if(!parsed)
      getTimeObj().parseString(timeStr);
