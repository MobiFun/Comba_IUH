...
EXTRTMETHOD int Asn1ErrorHandler::invoke (OSCTXT* pCtxt, ASN1CCB* pCCB, int stat)
{
...
EXTRTMETHOD int Asn1ErrorHandler::invoke (OSCTXT* pCtxt, OSOCTET* ptr, int len, int stat)
{
   if (0 != ACINFO(pCtxt)->errHndlrCB) {
      ASN1CCB ccb;
      Asn1ErrorHandler* pHandler = 
