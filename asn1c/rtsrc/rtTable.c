...
/* BOOLEAN (OSBOOL) */
EXTRTMETHOD int rtCmpTCBoolean (OSBOOL* key, OSBOOL* pCmpValue)
{
   if(*key == *pCmpValue) {
      return 0;
   }
...
/* INTEGER (OSINT8) */
EXTRTMETHOD int rtCmpTCINT8 (OSINT8* key, OSINT8* pCmpValue)
{
   if(*key == *pCmpValue)
      {
         return 0;
...
EXTRTMETHOD int rtCmpTCUINT8 (OSUINT8* key, OSUINT8* pCmpValue)
{
   if(*key == *pCmpValue)
      {
         return 0;
...
EXTRTMETHOD int rtCmpTCSINT (OSINT16* key, OSINT16* pCmpValue)
{
   if(*key == *pCmpValue)
      {
         return 0;
...
EXTRTMETHOD int rtCmpTCUSINT (OSUINT16* key, OSUINT16* pCmpValue)
{
   if(*key == *pCmpValue)
      {
         return 0;
...
EXTRTMETHOD int rtCmpTCINT (OSINT32* key, OSINT32* pCmpValue)
{
   if(*key == *pCmpValue)
      {
         return 0;
...
EXTRTMETHOD int rtCmpTCUINT (OSUINT32* key, OSUINT32* pCmpValue)
{
   if(*key == *pCmpValue)
      {
         return 0;
...
EXTRTMETHOD int rtCmpTCINT64 (OSINT64* key, OSINT64* pCmpValue)
{
   if(*key == *pCmpValue)
      {
         return 0;
...
EXTRTMETHOD int rtCmpTCUINT64 (OSUINT64* key, OSUINT64* pCmpValue)
{
   if(*key == *pCmpValue)
      {
         return 0;
...
EXTRTMETHOD int rtCmpTCOID (ASN1OBJID* key, ASN1OBJID* pcompOID)
{
   /* CmpTC No. Of Subids */
...
/* BMP STRING */
EXTRTMETHOD int rtCmpTC16BitCharStr (Asn116BitCharString* key, 
                         Asn116BitCharString* pCmpValue)
{
   ...
   return rtCmpTCUINT(&key->nchars, &pCmpValue->nchars);
}

/* Universal string */
EXTRTMETHOD int rtCmpTC32BitCharStr (Asn132BitCharString* key, Asn132BitCharString* pCmpValue)
{
   if(key->nchars == pCmpValue->nchars)
      {
         unsigned int i;
...
EXTRTMETHOD int rtCmpTCReal (OSREAL* key, OSREAL* pCmpValue)
{
   if(*key == *pCmpValue)
      {
         return 0;
