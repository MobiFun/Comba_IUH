...
EXTRTMETHOD void rtAddEventHandler (OSCTXT* pctxt, 
...
EXTRTMETHOD void rtInvokeStartElement (OSCTXT* pctxt, const char* name, int index)
{
   Asn1NamedCEventHandler* pHandler;
...
EXTRTMETHOD void rtInvokeEndElement (OSCTXT* pctxt, const char* name, int index)
{
   Asn1NamedCEventHandler* pHandler;
...
EXTRTMETHOD void rtInvokeBitStrValue (OSCTXT* pctxt, 
                          OSUINT32 numbits, 
                          const OSOCTET* data)
{
   Asn1NamedCEventHandler* pHandler;
...
EXTRTMETHOD void rtInvokeOctStrValue (OSCTXT* pctxt, 
                          OSUINT32 numocts, 
                          const OSOCTET* data)
{
   Asn1NamedCEventHandler* pHandler;
...
EXTRTMETHOD void rtInvokeCharStr16BitValue (OSCTXT* pctxt, 
                                OSUINT32 nchars, 
                                OSUNICHAR* data)
{
   Asn1NamedCEventHandler* pHandler;
...
EXTRTMETHOD void rtInvokeCharStr32BitValue (OSCTXT* pctxt, 
                                OSUINT32 nchars, 
                                OS32BITCHAR* data)
{
   Asn1NamedCEventHandler* pHandler;
...
EXTRTMETHOD void rtInvokeOidValue (OSCTXT* pctxt, 
                       OSUINT32 numSubIds, 
                       OSUINT32* pSubIds)
{
   Asn1NamedCEventHandler* pHandler;
...
EXTRTMETHOD void rtInvokeEnumValue (OSCTXT* pctxt, OSUINT32 value, const OSUTF8CHAR* text)
{
   Asn1NamedCEventHandler* pHandler;
   OSRTSListNode* pListNode = ACINFO(pctxt)->evtHndlrList.head;
...
EXTRTMETHOD void rtInvokeOpenTypeValue (OSCTXT* pctxt, 
                            OSUINT32 numocts, 
                            const OSOCTET* data)
{
   Asn1NamedCEventHandler* pHandler;
