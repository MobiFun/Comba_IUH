...
/***********************************************************************
 *
 *  Routine name: xe_null
 *
 *  Description:  This routine encodes the ASN.1 universal null field.
 *                If explicit tagging is specified, it adds the universal
 *                tag.  The overall length of the encoded field is returned.
 *
 *  Inputs:
 *
