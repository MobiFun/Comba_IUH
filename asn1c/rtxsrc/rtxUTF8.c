...
EXTRTMETHOD long rtxUTF8ToUnicode 
...
EXTRTMETHOD int rtxValidateUTF8 (OSCTXT* pctxt, const OSUTF8CHAR* inbuf)
{
...
EXTRTMETHOD size_t rtxCalcUTF8Len (const OSUTF8CHAR* inbuf, size_t inbufBytes) 
{
   size_t inbufx = 0;
...
EXTRTMETHOD size_t rtxUTF8Len (const OSUTF8CHAR* inbuf) 
{
...
EXTRTMETHOD size_t rtxUTF8LenBytes (const OSUTF8CHAR* inbuf) 
{
   size_t len = 0;
...
EXTRTMETHOD int rtxUTF8CharSize (OS32BITCHAR wc) 
{
   if (wc >= 0x80) {
#if defined(_ARMTCC) || defined(__SYMBIAN32__)
...
EXTRTMETHOD int rtxUTF8EncodeChar (OS32BITCHAR wc, OSOCTET* buf, size_t bufsiz)
{
   size_t nbytes = 0;
...
EXTRTMETHOD int rtxUTF8DecodeChar 
...
EXTRTMETHOD OS32BITCHAR rtxUTF8CharToWC (const OSUTF8CHAR* buf, OSUINT32* len)
{
   OS32BITCHAR value;
   OSOCTET  byte;
   OSUINT32 nbytes;
...
EXTRTMETHOD OSUTF8CHAR* rtxUTF8Strdup 
(OSCTXT* pctxt, const OSUTF8CHAR* utf8str)
{
   if (0 != utf8str) {
      ...
      if (0 != pbuf) {
         OSCRTLMEMCPY (pbuf, utf8str, nbytes);
      }
      return pbuf;
   }
   else return 0;
...
EXTRTMETHOD OSUTF8CHAR* rtxUTF8Strndup 
...
EXTRTMETHOD OSUTF8CHAR* rtxUTF8StrRefOrDup 
(OSCTXT* pctxt, const OSUTF8CHAR* utf8str)
{
   return (0 != rtxMemAutoPtrRef (pctxt, (void*)utf8str)) ?
      (OSUTF8CHAR*)utf8str : rtxUTF8Strdup (pctxt, utf8str);
}
...
EXTRTMETHOD OSBOOL rtxUTF8StrEqual 
...
EXTRTMETHOD OSBOOL rtxUTF8StrnEqual 
...
EXTRTMETHOD int rtxUTF8Strncmp 
(const OSUTF8CHAR* utf8str1, const OSUTF8CHAR* utf8str2, size_t count)
{
   OSUINT32 i = 0;
...
EXTRTMETHOD OSUTF8CHAR* rtxUTF8StrChr 
 ...
 */
EXTRTMETHOD int rtxUTF8RemoveWhiteSpace 
 ...
 */
EXTRTMETHOD const OSUTF8CHAR* rtxUTF8StrNextTok 
...
EXTRTMETHOD OSUTF8CHAR* rtxUTF8Strcpy 
...
EXTRTMETHOD OSUTF8CHAR* rtxUTF8Strncpy 
...
EXTRTMETHOD OSUINT32 rtxUTF8StrHash (const OSUTF8CHAR* str)
{
   OSUINT32 hash = 5381;
   int c;
...
EXTRTMETHOD const OSUTF8CHAR* rtxUTF8StrJoin 
