...
EXTERNRT void rtxInstallPrint (int (*newFunct)(char *fmat, va_list args));
...
(FILE* fp, const OSOCTET* data, OSUINT32 numocts);
...
(const OSOCTET* data, OSUINT32 numocts, char* buffer, int bufferIndex, 
 int bufferSize);
