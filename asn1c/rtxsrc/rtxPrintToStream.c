...
EXTRTMETHOD void rtxPrintToStreamBoolean (OSCTXT* pctxt, const char* name, OSBOOL value)
{
   rtxPrintToStream (pctxt, "%s = %s\n", name, value ? "true" : "false");
}

EXTRTMETHOD void rtxPrintToStreamInteger (OSCTXT* pctxt, const char* name, OSINT32 value)
{
   rtxPrintToStream (pctxt, "%s = %d\n", name, value);
}

EXTRTMETHOD void rtxPrintToStreamInt64 (OSCTXT* pctxt, const char* name, OSINT64 value)
{
   rtxPrintToStream (pctxt, "%s = "OSINT64FMT"\n", name, value);
}

EXTRTMETHOD void rtxPrintToStreamUnsigned (OSCTXT* pctxt, const char* name, OSUINT32 value)
{
   rtxPrintToStream (pctxt, "%s = %u\n", name, value);
}

EXTRTMETHOD void rtxPrintToStreamUInt64 (OSCTXT* pctxt, const char* name, OSUINT64 value)
{
...
(OSCTXT* pctxt, const char* name, OSUINT32 numocts, const OSOCTET* data)
{
   rtxPrintToStream (pctxt, "%s.numocts = %u\n", name, numocts);
   rtxPrintToStream (pctxt, "%s.data = \n", name);
   rtxHexDumpToStream (pctxt, data, numocts);
}

EXTRTMETHOD void rtxPrintToStreamReal (OSCTXT* pctxt, const char* name, OSREAL value)
{
...
EXTRTMETHOD void rtxPrintToStreamIncrIndent ()
{
   g_indent += OSRTINDENTSPACES;
}

EXTRTMETHOD void rtxPrintToStreamDecrIndent ()
{
   if (g_indent > 0) 
      g_indent -= OSRTINDENTSPACES;
}
...
EXTRTMETHOD void rtxHexDumpToStream (OSCTXT* pctxt, const OSOCTET* data, OSUINT32 numocts)
{
...
(OSCTXT* pctxt, const OSOCTET* data, OSUINT32 numocts, int bytesPerUnit)
{
   ...
   int      k, unitsPerLine = 16 / bytesPerUnit, ai, shift, avail_buf;
   ...
   {
      pbuf = (char*)buf;
      avail_buf = (int)(sizeof(buf) - 1); /* 20 characters + NUL. */
           ...
           k++, pbuf += 2, avail_buf -= 2, shift -= 8) 
      {
         ...
         OSRTASSERT (avail_buf > 0);
         os_snprintf (pbuf, avail_buf, "%02x", b);
