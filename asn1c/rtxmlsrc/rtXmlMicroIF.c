...
static void* memAlloc (OSMemBlock* pMemBlk, int size)
{
   void* ptr;
      ...
      if (prevState != state) {
         switch (state) {
            ...
            case 31: /* end of endElement */
               ...
               OSCRTLMEMCPY (qname, qnamePtr, endNamePtr - qnamePtr);
               ...
               if (qnamePtr != localNamePtr) {
                  ...
                  OSCRTLMEMCPY (localName, localNamePtr, endNamePtr - localNamePtr);
            ...
            case 16: /* attribute name, ending (= recvd) */
               ...
               OSCRTLMEMCPY (attrName, attrNamePtr, p - attrNamePtr);
            ...
            case 18: /* attribute value, ending */
               ...
               OSCRTLMEMCPY (attrValue, attrValPtr, p - attrValPtr);
