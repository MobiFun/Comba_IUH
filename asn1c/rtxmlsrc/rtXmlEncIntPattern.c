...
(OSRTMEMBUF* pMemBuf, OSINT32 value, int* pState,
...
(OSCTXT* pOSCTXT, rtxRegexpPtr regexp, OSINT32 value, OSUTF8CHAR** ppDest) 
{
...
EXTXMLMETHOD int rtXmlEncIntPatternValue 
(OSCTXT* pctxt, OSINT32 value, const OSUTF8CHAR* pattern)
{
   int stat = 0;
...
EXTXMLMETHOD int rtXmlEncIntPattern (OSCTXT* pctxt, OSINT32 value, 
                        ...
                        const OSUTF8CHAR* pattern)
{
   ...
   if (0 == stat)
      stat = rtXmlEncIntPatternValue (pctxt, value, pattern);
