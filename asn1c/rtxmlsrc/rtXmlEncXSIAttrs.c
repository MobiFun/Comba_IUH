...
static const OSUTF8CHAR XSI_NS[] = "http://www.w3.org/2001/XMLSchema-instance";
#define XSI_NS_LEN (sizeof(XSI_NS)-1)
...
EXTXMLMETHOD int rtXmlEncXSIAttrs (OSCTXT* pctxt, OSBOOL needXSI)
{
   ...
   {
      rtXmlNSAddPrefixLink (pctxt, OSUTF8("xsi"), XSI_NS,
         pXMLInfo->nsURITable.data, pXMLInfo->nsURITable.nrows);

      stat = rtXmlEncUTF8Attr2 
         (pctxt, OSUTF8("xmlns:xsi"), 9, XSI_NS, XSI_NS_LEN);      
