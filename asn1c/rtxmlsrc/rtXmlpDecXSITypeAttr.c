...
EXTXMLMETHOD int rtXmlpDecXSITypeAttr (OSCTXT* pctxt, const OSXMLNameFragments* attrName, 
...
EXTXMLMETHOD int rtXmlpGetXSITypeAttr (OSCTXT* pctxt, const OSUTF8CHAR** ppAttrValue, 
...
EXTXMLMETHOD int rtXmlpLookupXSITypeIndex (OSCTXT* pctxt, const OSUTF8CHAR* xsiType,
                              OSINT16 xsiTypeIdx,
...
EXTXMLMETHOD int rtXmlpGetXSITypeIndex (OSCTXT* pctxt, const OSXMLItemDescr typetab[], 
                           size_t typetabsiz)
{
