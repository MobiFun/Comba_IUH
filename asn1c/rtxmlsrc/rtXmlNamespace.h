...
typedef struct OSXMLNSPfxLink {
   OSINT32 nsidx;
   OSXMLNamespace ns; /* primary namespace prefix is in this record */
   OSRTDynPtrArray extraPrefixes; /* holds additional prefixes for this URI */
 ...
 *
 * @param pqname        Pointer to QName structure to be populated.
 *                        Pointers to items in pNS are assigned directly 
 *                        to fields in pqname.  No copies of data are made.
