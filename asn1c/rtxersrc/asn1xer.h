 ...
 *                       - negative return value is error.
 */
EXTERNXER int xerEncReal10 (OSCTXT* pctxt, const char* value, 
                          const char* elemName);
...
/**
 * This function returns a string that describes the features of the XER
 * runtime library.  Different release kits will return different strings.
 * A typical example is &quot;ASN1XER v6.1.1, opt, compact, limited.&quot;
 */
EXTERNXER const char *xerGetLibInfo ();

/**
 * This function returns the integer representation of the XER library 
 * version.
 */
EXTERNXER int xerGetLibVersion ();
